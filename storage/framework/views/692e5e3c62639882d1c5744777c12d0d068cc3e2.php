...
<html lang="en">
  ...
  <body class="min-h-screen bg-gray-50 bg-[url('/wave.svg')] bg-fixed bg-bottom bg-no-repeat">
    <header class="flex items-center justify-between p-6">
      ...
      <div>
        <a href="<?php echo e(route('dashboard')); ?>" class="rounded-md bg-green-600 py-2 px-4 font-semibold text-white shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl 
    ...
    <!----------------------------------------------Name---------------------------------------------------------------------------------------->    
        <form action="<?php echo e(route('register')); ?>" method="post" novalidate autocomplete="off" class="space-y-6">
        <?php echo csrf_field(); ?><!- буде показувати домен в браузері->
          <div>
...
<!-----------------------------------------------Confirm Password------------------------------------------------------------------------------------------>
          ...
          <div>
            <a href="<?php echo e(route('welcome')); ?>" class="w-full flex items-center justify-center rounded-md bg-green-600 py-2 px-4 font-semibold text-white shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 
            focus:ring-green-500 focus:ring-offset-2">Register</a>
          </div>
        </form>

        <div class="mt-6 flex items-center justify-center">
          <a href="<?php echo e(route('dashboard')); ?>" class="text-sm font-medium text-green-600 hover:text-green-500">Already have an account?</a>
        </div>
      </div>
    </main>
  </body>
</html><?php /**PATH G:\Installation\OpenServer\example-app\resources\views/register.blade.php ENDPATH**/ ?>